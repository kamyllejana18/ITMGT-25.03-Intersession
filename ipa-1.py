...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    # Replace `pass` with your code.
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    waste_job = num_jobs*job_consumption
    material = total_material-waste_job
    return str(material)+material_units

waste=material_waste(45,"L",4,3)
print("Material Waste:",waste)
...
with_interest=interest(1000, 0.25, 6)
print("Final value of investment:",with_interest)
...
def body_mass_index(weight, height):
    ...
    # Replace `pass` with your code.
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    kilogram=0.453592*weight
    height_metric = height[0] * 0.3048 + height[1] * 0.0254
    BMI=kilogram/height_metric**2
    return float(BMI)

B_M_I=body_mass_index(50, [5,10])
print("BMI:",B_M_I)